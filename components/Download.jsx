...
const Download = () => {
    // Check for screen size for responsive design
    const isExtraSmall = typeof window !== 'undefined' && window.innerWidth <= 600;
            ...
            >
                <div className="container mx-auto">
                    <div className={`flex ${isMobileOrTablet ? 'flex-col items-center' : 'items-center'}`}>
                        <div className={`relative mr-6 flex-540 ${isMobileOrTablet ? 'flex-100' : 'flex-280 max-lg:flex-256'}`}>
                            <div className="mb-10">
                                <img
                                    src="/favicon.ico"
                                    width={120}
                            ...
                            <ul className={`flex flex-wrap mb-4 items-center gap-6 ${isMobileOrTablet ? 'justify-center' : ''}`}>
                                {links.map(({ id, url, icon }) => (
                                    ...
                                    >
                                        <a
                                            href={url} // Demo link here
                                            className="size-22 download_tech-icon_before relative flex items-center justify-center rounded-full border-2 border-gray-700 bg-gray-100 hover:border-gray-500 transition duration-500"
                                        >
                      <span className="absolute -top-2 rotate-90">
                        {/* You can customize the Marker component here */}
                        ...
                        {!isMobileOrTablet && (
                            <div className="mb-10 max-md:hidden">
                                <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-gray-600 p-6">
                                    <div className="relative rounded-3xl bg-gray-100 px-6 pb-6 pt-14">
                                        <span className="download_preview-dot left-6 bg-blue-600" />
                                        <span className="download_preview-dot left-11 bg-gray-500" />
                                        <span className="download_preview-dot left-16 bg-gray-300" />
                    ...
                    {isMobileOrTablet && (
                        <div className="mb-10 w-full">
                            <div className="download_preview-before download_preview-after rounded-40 relative w-full border-2 border-gray-600 p-6">
                                <div className="relative rounded-3xl bg-gray-100 px-6 pb-6 pt-14">
                                    <img
                                        src="/images/ss.png"
